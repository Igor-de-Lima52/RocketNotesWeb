        ...
        <Content>
          ...
          <div className="scrollable">
            <div className="content">
              <div className="title">
                <h2>Interestellar</h2>
                <span className="rate">4</span><img className="star" src={starImg} alt="Imagem de uma estrela rosa"/>
              </div>
              <Data>
                <div>
                  <img src="https://github.com/Igor-de-Lima52.png"/>
                  <p>Por Igor de Lima</p>
                </div>
                <div>
            ...
            <Section>
              <p>
                ...
                que tenta se comunicar com ela. Pai e filha descobrem que o "fantasma" é uma inteligência desconhecida 
                ...
                planetas que podem oferecer condições de sobrevivência para a espécie humana. 
                ...
                dados dos astronautas; se um dos planetas se mostrar habitável, a humanidade irá seguir para 
                ele na instalação da NASA, que é na realidade uma enorme estação espacial. 
              ...
              <p>
                ...
                enorme dilatação gravitacional temporal por estar tão perto de Gargântua: 
                cada hora na superfície equivale a sete anos na Terra. Eles entram em Miller e descobrem 
                que é inóspito já que é coberto por um oceano raso e agitado por ondas enormes. 
